...
Func NewPots ()
	...
	GUICreate("Activation Sequence", 500, 300, -1, -1)
	...
	GUICtrlCreateLabel("Action 6:",30,200,200,20) ;Button 06
	Global $nSkillButton06 = GUICtrlCreateInput (IniRead("config.ini", "Config", "SkillButton06", ""), 270, 200, 70, 20,-1)
	Global $nSkillTime06 = GUICtrlCreateInput (IniRead("config.ini", "Config", "SkillTime01", ""), 400, 200, 70, 20,$ES_NUMBER)

	GUISetOnEvent($GUI_EVENT_CLOSE, "SpecialEvents")
    GUISetOnEvent($GUI_EVENT_MINIMIZE, "SpecialEvents")
    GUISetOnEvent($GUI_EVENT_RESTORE, "SpecialEvents")

    GUICtrlCreateButton("OK", 130, 250, 100, 30)
    GUICtrlSetOnEvent(-1, "OKPressed")

    GUICtrlCreateButton("Cancel", 270, 250, 100, 30)
